...
module cmsdk_apb_subsystem #(
  ...
  parameter  INCLUDE_APB_GPIO0      = 1,  //*H* //0X4000  Include simple UART #0
...
// --------------------------------------------------------------------------
  ...
  cmsdk_apb_slave_mux
    ...
    //*H*	
    .PSEL4             (gpio0_psel),
    .PREADY4           (gpio0_pready),
    .PRDATA4           (gpio0_prdata),
    .PSLVERR4          (gpio0_pslverr),
